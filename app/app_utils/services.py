...
def get_memory_service():
    """Process-wide memory service: Vertex AI Memory Bank when agent engine ID is configured, else in-memory."""
    agent_engine_id = (
        os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID")
        or "2446663510696919040"
    )
    project = (
        os.environ.get("GOOGLE_CLOUD_PROJECT")
        or "qwiklabs-gcp-03-9683cc1b79ba"
    )
    location = (
